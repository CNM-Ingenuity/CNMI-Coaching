...
function show_letter_upload() {
	...
	if($progressID) {
		...
		include(locate_template('partials/forms/letter-upload.php'));
	} else {
		?>
...
add_action('genesis_entry_content', 'show_letter_upload');
